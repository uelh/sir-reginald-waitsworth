...
export async function execute(interaction: ChatInputCommandInteraction<CacheType>) {
    ...
    return interaction.reply({
      embeds: [
        new EmbedBuilder()
          ...
          .setColor(0x00cc99)
          .setFooter({ text: 'Everyone’s been perfectly punctual. I must be dreaming.' }),
      ],
    });
  }
  ...
  const embed = new EmbedBuilder()
    .setTitle('🏆 The Waitboard')
    .setColor(0xffcc00)
    .setDescription(`Here lie the names of those most proficient in the art of making others wait.`)
